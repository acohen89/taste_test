                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed: () async {
                              ...
                              String? lnameValidation = validateLName(lnameController.text);
                              String? emailValidation = validateEmail(emailController.text);
                              String? fnameValidation = validateFName(fnameController.text);
                              setState(() {
                              ...
                              if (passValidation == null && lnameValidation == null && fnameValidation == null) {
                                showDialog(
                                    context: context,
                                    builder: (context) {
                                ...
                                Response res = await signup(
                                    usernameController.text, passwordController.text, fnameController.text, lnameController.text, emailController.text);
